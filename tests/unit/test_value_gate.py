...
class TestClassifyDataType:
    def test_frontmatter_data_type(self) -> None:
        item = RawItem(
            source_path="docs/test.md", content="# Test", original_metadata={"data_type": "faq"}
        )
...
class TestCheckColdData:
    def test_raw_log_rejected(self) -> None:
        item = RawItem(
            source_path="a.log",
            content="2026-04-27T10:00:01Z INFO server started",
            original_metadata={},
        )
    ...
    def test_all_data_types_accepted(self) -> None:
        ...
        for dtype in DataType:
            item = RawItem(
                ...
                original_metadata={"data_type": dtype.value},
            )
